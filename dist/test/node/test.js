...
const ordRaw = raw_json_1.default[2];
(0, globals_1.describe)("BPU", function () {
    (0, globals_1.describe)("transform", function () {
        (0, globals_1.test)("larger than 512 bytes => ls", async function () {
            let result = await (0, src_1.parse)({
                tx: { r: largeraw },
                split: [
                    {
                        token: { s: "|" },
    ...
    (0, globals_1.describe)("txid", function () {
        (0, globals_1.test)("has ord txid", async function () {
            let result = await (0, src_1.parse)({
                tx: { r: ordRaw },
                split: [
                    { token: { ops: "OP_RETURN" } },
            ...
            assert_1.default.equal(result.tx.h, "10f4465cd18c39fbc7aa4089268e57fc719bf19c8c24f2e09156f4a89a2809d6");
            assert_1.default.equal(result.out[0].tape.length, 2);
            //let tape = result.out[0].tape[0];
        });
    });
