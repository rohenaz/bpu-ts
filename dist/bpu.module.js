    ...
    xputs.forEach(function(xput, xput_index) {
        if (xput.script) {
            ...
            if (type === "in") {
                ...
                const address1 = (0, $dhIrD$Address).fromTxOutScript(xput.script).toString();
...
const bpu = {
    parse: parse,
    RpcClient: $dhIrD$bitcoindrpc
};
var $a038725a0a6f963e$export$2e2bcd8739ae039 = bpu;
...
//# sourceMappingURL=bpu.module.js.map
